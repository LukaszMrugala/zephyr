...
class TestReport:
    ...
    def test_log_file(self, capfd, out_path, test_path, test_platforms, file_name):
        tmp_log_file_path = os.path.join(out_path, file_name)
        args = ['-i', '--outdir', out_path, '-T', test_path, "--log-file", tmp_log_file_path] + \
               [val for pair in zip(
                   ['-p'] * len(test_platforms), test_platforms
               ) for val in pair]
    ...
    def test_coverage(self, capfd, out_path, test_path, test_platforms, file_name):
        args = ['-i', '--outdir', out_path, '-T', test_path,
    ...
    def test_enable_coverage(self, capfd, out_path, test_path, test_platforms, expected):
